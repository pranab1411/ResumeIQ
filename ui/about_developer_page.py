...
Dedicated About Application & Developer Profile Pages.
"""
...
class AboutAppPage(QWidget):
    """
    Dedicated About Application Page containing AI engine status, system information, 
    architecture promises, and technology stack grid.
    """
    ...
    def _init_ui(self):
        ...
        header_title = QLabel("ℹ️ About ResumeIQ Application & Architecture")
        header_title.setObjectName("HeaderTitle")
        header_title.setStyleSheet("font-size: 22px; font-weight: bold; color: #F8FAFC;")
        
        header_sub = QLabel("Hybrid Gemini AI & spaCy NLP Resume Intelligence & Career Suite")
        ...
        mission_badge = QLabel("CORE ENGINE ARCHITECTURE")
        ...
        p1 = QLabel("• <b>Google Gemini AI:</b> 4-part candidate profile evaluation (Skills, Education, Positions, Experience Years/Months) & 50+ universal role predictions.")
        p1.setWordWrap(True)
        p1.setStyleSheet("font-size: 12.5px; color: #CBD5E1;")

        p2 = QLabel("• <b>On-Device spaCy NLP:</b> Fast candidate entity extraction, contact info parsing, and 4-pillar MCDA ATS scoring with zero cloud dependency when offline.")
        p2.setWordWrap(True)
        p2.setStyleSheet("font-size: 12.5px; color: #CBD5E1;")

        p3 = QLabel("• <b>Field-Specific Asset Intelligence:</b> Recommends GitHub, Behance, Medical Licensure, CPA, or Bar Admission based on candidate industry.")
        p3.setWordWrap(True)
        p3.setStyleSheet("font-size: 12.5px; color: #CBD5E1;")
        ...
        content_layout.addWidget(mission_card)
        ...
        footer_lbl = QLabel("ResumeIQ v2.0 • All Rights Reserved")
...
class AboutDeveloperPage(QWidget):
    """
    Dedicated Developer Profile Page focused strictly on Developer Information.
    Contains zero software engine clutter.
    """
    def __init__(self, parent=None):
        super().__init__(parent)
        self._init_ui()
    ...
    def _init_ui(self):
        ...
        # Header Title
        header_box = QVBoxLayout()
        header_title = QLabel("👨‍💻 Developer Profile")
        header_title.setObjectName("HeaderTitle")
        header_title.setStyleSheet("font-size: 22px; font-weight: bold; color: #F8FAFC;")
        
        header_sub = QLabel("Lead Developer & Software Architect Profile")
        header_sub.setStyleSheet("font-size: 13px; color: #94A3B8;")
        ...
        dev_badge.setStyleSheet("font-size: 11px; font-weight: bold; color: #818CF8; letter-spacing: 1px;")
        
        dev_name = QLabel("Pranab Chourasiya")
        dev_name.setStyleSheet("font-size: 24px; font-weight: bold; color: #F8FAFC;")

        dev_bio = QLabel(
            "Lead Software Architect & Engineer of ResumeIQ.\n\n"
            "Passionate about building intelligent AI desktop software, privacy-first NLP processing engines, "
            "and user-centric applications designed to solve real-world problems for job seekers."
        )
        dev_bio.setWordWrap(True)
        dev_bio.setStyleSheet("font-size: 13.5px; color: #CBD5E1; line-height: 1.6;")
        ...
        btn_linkedin.setStyleSheet("""
            QPushButton {
                background: #0A66C2; color: white; border-radius: 6px; padding: 10px 16px; font-weight: bold; font-size: 12px;
            }
        ...
        btn_github.setStyleSheet("""
            QPushButton {
                background: #334155; color: #F8FAFC; border-radius: 6px; padding: 10px 16px; font-weight: bold; font-size: 12px;
            }
            QPushButton:hover { background: #475569; }
        """)
        btn_github.clicked.connect(lambda: QDesktopServices.openUrl(QUrl("https://github.com/pranab1411")))

        btn_repo = QPushButton("⭐ ResumeIQ Repository")
        btn_repo.setCursor(Qt.CursorShape.PointingHandCursor)
        btn_repo.setStyleSheet("""
            QPushButton {
                background: #4F46E5; color: white; border-radius: 6px; padding: 10px 16px; font-weight: bold; font-size: 12px;
            }
        ...
        btn_email.setStyleSheet("""
            QPushButton {
                background: #059669; color: white; border-radius: 6px; padding: 10px 16px; font-weight: bold; font-size: 12px;
            }
        ...
        # Footer Version Details
        footer_lbl = QLabel("ResumeIQ • Crafted with ❤️ by Pranab Chourasiya")
        footer_lbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
        footer_lbl.setStyleSheet("font-size: 11.5px; color: #64748B; margin-top: 20px;")
        content_layout.addWidget(footer_lbl)
